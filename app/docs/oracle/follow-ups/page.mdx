...
The Oracle includes a share button that generates a URL with a `?q=` parameter encoding your query. When someone opens this URL, Framewerk loads with the Oracle pre-filled with your query and automatically runs it.
