...
Synapse Mode is Framewerk's immersive exploration feature. Double-click any node to enter a close-up view that lets you fly between connected models, following the graph's dendrite pathways.
