...
The 2,796 edges in Framewerk represent semantic relationships between mental models. Each edge has a type that describes the nature of the connection. Understanding these types is key to reading the graph effectively.
